...
#define UNINITIALIZED_CHANNEL_STATE 0
#define INITIAL_CHANNEL_STATE 1
#define REMOTE_REPORT_OBTAINED 2
#define REMOTE_REPORT_VERIFIED 4
#define MUTUAL_ATTESTATION_STATE                                               \
  (REMOTE_REPORT_OBTAINED | REMOTE_REPORT_VERIFIED)
#define SECURE_CHANNEL_STATE 8
...
public:
  ...
  bool generate_remote_report(const uint8_t *data, size_t data_size,
   ...
   * report_data field.
   */
  bool attest_remote_report(const uint8_t *remote_report,
                            size_t remote_report_size, const uint8_t *data,
                            size_t data_size);
};
